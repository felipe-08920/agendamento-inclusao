  ...
  <main>
    <form class="row g-3" method="POST">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="cid" name="cid" placeholder="Insira o CID do Aluno" required>
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="nomeAluno" name="nomeAluno" placeholder="Insira o Nome do Aluno"
          required>
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="idade" name="idade" placeholder="Insira a Idade do Aluno" required>
      </div>
      <div class="title">
